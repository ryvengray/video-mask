...
DEFAULT_EXTRA_ARGS=(--fisheye --fisheye-device pico4 --face-size 960 --face-int 5 --frame-skip 3 --face-model yolov8)
DEFAULT_EXTRA_LINE="--fisheye --fisheye-device pico4 --face-size 960 --face-int 5 --frame-skip 3 --face-model yolov8"
